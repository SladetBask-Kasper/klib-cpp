...
public:
    ...
    /// Last thing but with char arrays
    static bool w_test_connect(char *Server_IP_Address, int port = 80) {
    ...
    /// Last thing but with char arrays
    static bool w_connect_and_send(char *Server_IP_Address, int port = 80, char* sendbuf = "DEFAULT_SEND_MESSAGE") {
